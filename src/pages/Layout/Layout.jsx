            ...
            <div className={`bg-${theme.theme}`}>
                ...
                <nav className={`navbar shadow-sm p-4 sticky-top navbar-expand-lg bg-${theme.theme} border-bottom border-4`}>
                    <div className="container">
                        {/* Icono */}
                        <div>
                            <Link to={"/"}><img src={icono} style={{ height: "65px" }} /></Link>
                        </div>
                ...
                {/* para el renderizado de cada ruta */}
                <Outlet />
                ...
                <div className="d-flex justify-content-around align-items-center flex-column p-5" style={{ backgroundColor: "#a5eea0" }}>
                    ...
                    <p className="mt-2">&copy; {derechos} - 2022</p>
                </div>
            </div>
