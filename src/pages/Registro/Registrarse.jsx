                                        ...
                                        <form action="#" className="mx-1 mx-md-4">
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    <label className="form-label" for="form3Example1c">Nombre y Apellido</label>
                                            ...
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    <label className="form-label" for="form3Example3c">Correo Electrónico</label>
                                            ...
                                            <div className="form-check d-flex justify-content-center mb-5">
                                                ...
                                                <label className="form-check-label" for="form2Example3">Estoy de acuerdo con todos los <a href="terminos.html" target="_blank">Términos de servicio</a></label>
                                            </div>
