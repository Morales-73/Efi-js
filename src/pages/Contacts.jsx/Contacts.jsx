          ...
          <div className="col-6 p-5 mb-5 d-flex flex-column justify-content-evenly align-items-center">
            ...
            <div className="text-center">
              <a href="" target="_blank">
                <svg className="me-5 bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill={`${theme.color}`} viewBox="0 0 16 16">
              ...
              <a href="" target="_blank">
                <svg className="ms-5 bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill={`${theme.color}`} viewBox="0 0 16 16">
